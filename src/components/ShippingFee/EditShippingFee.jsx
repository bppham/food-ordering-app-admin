...
const EditShippingFee = ({ shippingFeeData, onClose, onSubmit }) => {
  ...
  useEffect(() => {
    if (shippingFeeData) {
      setFormData({
        _id: shippingFeeData._id,
        fromDistance: shippingFeeData.fromDistance || "",
        feePerKm: shippingFeeData.feePerKm || "",
      });
    }
  }, [shippingFeeData]);
